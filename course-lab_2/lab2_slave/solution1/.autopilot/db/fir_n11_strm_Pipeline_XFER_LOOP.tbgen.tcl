...
set C_modelArgMapList {[ 
	{ "Name" : "an32Coef", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln19", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln19 sc_in sc_lv 31 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln19", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "zext_ln19", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln19 { ap_none {  { zext_ln19 in_data 0 31 } } }
