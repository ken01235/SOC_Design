...
`define AUTOTB_DUT      fir_n11_maxi
`define AUTOTB_DUT_INST AESL_inst_fir_n11_maxi
`define AUTOTB_TOP      apatb_fir_n11_maxi_top
`define AUTOTB_LAT_RESULT_FILE "fir_n11_maxi.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fir_n11_maxi.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fir_n11_maxi_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_pn32HPInput 1
`define AESL_DEPTH_pn32HPOutput 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvin_gmem.dat"
`define AUTOTB_TVIN_pn32HPInput_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvin_pn32HPInput.dat"
`define AUTOTB_TVIN_pn32HPOutput_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvin_pn32HPOutput.dat"
`define AUTOTB_TVIN_an32Coef_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvin_an32Coef.dat"
`define AUTOTB_TVIN_regXferLeng_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvin_regXferLeng.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.fir_n11_maxi.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.fir_n11_maxi.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_pn32HPInput = 1;
parameter LENGTH_pn32HPOutput = 1;
parameter LENGTH_an32Coef = 12;
parameter LENGTH_regXferLeng = 1;
parameter LENGTH_gmem = 1200;
...
reg end_pn32HPInput;
reg [31:0] size_pn32HPInput;
reg [31:0] size_pn32HPInput_backup;
reg end_pn32HPOutput;
reg [31:0] size_pn32HPOutput;
reg [31:0] size_pn32HPOutput_backup;
reg end_an32Coef;
